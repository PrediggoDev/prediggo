...
class PrediggoCallController
{
	...
	*/
	public function homePageRecoIfHookMatch($sHookName, $params, $oPrediggoCall)
	{
		...
		if ((boolean)$this->oPrediggoConfig->home_0_activated && strcmp($this->oPrediggoConfig->home_0_hook_name, $sHookName) == 0)
		{
		...
		if ((boolean)$this->oPrediggoConfig->home_1_activated && strcmp($this->oPrediggoConfig->home_1_hook_name, $sHookName) == 0)
		{
	...
	*/
	public function allPageRecoIfHookMatch($sHookName, $params, $oPrediggoCall)
	{
		...
		if ((boolean)$this->oPrediggoConfig->allpage_0_activated && strcmp($this->oPrediggoConfig->allpage_0_hook_name, $sHookName) == 0)
		{
		...
		if ((boolean)$this->oPrediggoConfig->allpage_1_activated && strcmp($this->oPrediggoConfig->allpage_1_hook_name, $sHookName) == 0)
		{
		...
		if ((boolean)$this->oPrediggoConfig->allpage_2_activated && strcmp($this->oPrediggoConfig->allpage_2_hook_name, $sHookName) == 0)
		{
	...
	*/
	...
	{
		$aRecommendations = array();
		if ((boolean)$this->oPrediggoConfig->productpage_0_activated && strcmp($this->oPrediggoConfig->productpage_0_hook_name, $sHookName) == 0)
		{
		...
		if ((boolean)$this->oPrediggoConfig->productpage_1_activated && strcmp($this->oPrediggoConfig->productpage_1_hook_name, $sHookName) == 0)
		{
		...
		if ((boolean)$this->oPrediggoConfig->productpage_2_activated && strcmp($this->oPrediggoConfig->productpage_2_hook_name, $sHookName) == 0)
		{
	...
	*/
	public function basketPageRecoIfHookMatch($sHookName, $params, $oPrediggoCall)
	{
		...
		if ((boolean)$this->oPrediggoConfig->basket_0_activated && strcmp($this->oPrediggoConfig->basket_0_hook_name, $sHookName) == 0)
		{
			//echo 'Home Page Block #0 is active => computing recommendation<BR>';
		...
		if ((boolean)$this->oPrediggoConfig->basket_1_activated && strcmp($this->oPrediggoConfig->basket_1_hook_name, $sHookName) == 0)
		{
		...
		if ((boolean)$this->oPrediggoConfig->basket_2_activated && strcmp($this->oPrediggoConfig->basket_2_hook_name, $sHookName) == 0)
		{
		...
		if ((boolean)$this->oPrediggoConfig->basket_3_activated && strcmp($this->oPrediggoConfig->basket_3_hook_name, $sHookName) == 0)
		{
		...
		if ((boolean)$this->oPrediggoConfig->basket_4_activated && strcmp($this->oPrediggoConfig->basket_4_hook_name, $sHookName) == 0)
		{
		...
		if ((boolean)$this->oPrediggoConfig->basket_5_activated && strcmp($this->oPrediggoConfig->basket_5_hook_name, $sHookName) == 0)
		{
			//echo 'Basket Page Block #4 is active => computing recommendation<BR>';
	...
	*/
	public function createAddCondition($params)
	{
		$res = array();
        $value = null;
	...
	*/
	public function categoryPageRecoIfHookMatch($sHookName, $params, $oPrediggoCall)
	{
		...
		if ((boolean)$this->oPrediggoConfig->category_0_activated && strcmp($this->oPrediggoConfig->category_0_hook_name, $sHookName) == 0)
		{
			...
			$params['condition'] = $this->createAddCondition($params);
		...
		if ((boolean)$this->oPrediggoConfig->category_1_activated && strcmp($this->oPrediggoConfig->category_1_hook_name, $sHookName) == 0)
		{
		...
		if ((boolean)$this->oPrediggoConfig->category_2_activated && strcmp($this->oPrediggoConfig->category_2_hook_name, $sHookName) == 0)
		{
    ...
    public function customerPageRecoIfHookMatch($sHookName, $params, $oPrediggoCall)
    {
        ...
        if ((boolean)$this->oPrediggoConfig->customer_0_activated && strcmp($this->oPrediggoConfig->customer_0_hook_name, $sHookName) == 0)
        {
        ...
        if ((boolean)$this->oPrediggoConfig->customer_1_activated && strcmp($this->oPrediggoConfig->customer_1_hook_name, $sHookName) == 0)
        {
        ...
        if ((boolean)$this->oPrediggoConfig->customer_2_activated && strcmp($this->oPrediggoConfig->customer_2_hook_name, $sHookName) == 0)
        {
    ...
    public function getListOfRecommendationsWithDynamicTemplate($sHookName, $params)
    {
		...
		if ($sHookName == 'displayHome' || $sHookName == 'displayOrderConfirmation')

			return $this->homePageRecoIfHookMatch($sHookName, $params, $this->oPrediggoCall);

		else if ($sHookName == 'displayRightColumn' || $sHookName == 'displayLeftColumn' || $sHookName == 'displayTop' || $sHookName == 'displayFooter')

			return $this->allPageRecoIfHookMatch($sHookName, $params, $this->oPrediggoCall);

		else if ($sHookName == 'displayLeftColumnProduct' || $sHookName == 'displayRightColumnProduct' || $sHookName == 'displayProductButtons' || $sHookName == 'actionProductOutOfStock' ||
            $sHookName == 'displayFooterProduct' || $sHookName == 'displayProductTab' || $sHookName == 'displayProductTabContent')

			return $this->productPageRecoIfHookMatch($sHookName, $params, $this->oPrediggoCall);

		else if ($sHookName == 'displayShoppingCartFooter' || $sHookName == 'displayShoppingCart' || $sHookName == 'displayOrderDetail' ||
            $sHookName == 'displayBeforeCarrier' || $sHookName == 'displayCarrierList')

			return $this->basketPageRecoIfHookMatch($sHookName, $params, $this->oPrediggoCall);

		else if ($sHookName == 'displayRightColumncategory' || $sHookName == 'displayLeftColumncategory' || $sHookName == 'displayTopcategory' || $sHookName == 'displayFootercategory' ||
            $sHookName == 'displayRightColumnmanufacturer' || $sHookName == 'displayLeftColumnmanufacturer' || $sHookName == 'displayTopmanufacturer' || $sHookName == 'displayFootemanufacturer')

			return $this->categoryPageRecoIfHookMatch($sHookName, $params, $this->oPrediggoCall);

        else if ($sHookName == 'displayCustomerAccount' || $sHookName == 'displayMyAccountBlock' || $sHookName == 'displayMyAccountBlockfooter')
     ...
     * @param $sName
     * @param array $aLogs list of logs
     * @internal param string $sHookName Name of the hook
     */
