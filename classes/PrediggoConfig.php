...
class PrediggoConfig
{
	...
	private $aConfs = array(
        ...
        'customer_1_block_label' => array(
		 ...
		 /* CUSTOMER PAGE CONFIGURATION - Block 2 */
        'customer_2_activated' => array(
            'name' 				=> 'PREDIGGO_CUST_2_ACTIVATED',
            'type'				=> 'int',
            'val' 				=> 1,
            'multilang'			=> false,
            'multishopgroup'	=> false,
        ...
        'customer_2_nb_items' => array(
            'name' 				=> 'PREDIGGO_CUST_2_NB_RECO',
            'type'				=> 'int',
            'val' 				=> 5,
            'multilang'			=> false,
            'multishopgroup'	=> false,
        ...
        'customer_2_variant_id' => array(
            'name' 				=> 'PREDIGGO_CUST_2_VARIANT_ID',
            'type'				=> 'int',
            'val' 				=> 0,
            'multilang'			=> false,
            'multishopgroup'	=> false,
        ...
        'customer_2_hook_name' => array(
            'name' 				=> 'PREDIGGO_CUST_2_HOOK_NAME',
            'type'				=> 'select',
            'val' 				=> array(1 => 'Prediggo', 2 => 'Prediggo', 3 => 'Prediggo', 4 => 'Prediggo', 5 => 'Prediggo'),
            'multilang'			=> false,
            'multishopgroup'	=> false,
        ...
        'customer_2_template_name' => array(
            'name' 				=> 'PREDIGGO_CUST_2_TEMPLATE_NAME',
            'type'				=> 'text',
            'size'     			=> 100,
            'val' 				=> 'list_recommendations.tpl',
            'multilang'			=> false,
        ...
        'customer_2_block_label' => array(
            'name' 				=> 'PREDIGGO_CUST_2_BLOCK_LABEL',
            'type'				=> 'text',
            'val' 				=> array(1 => 'Prediggo', 2 => 'Prediggo', 3 => 'Prediggo', 4 => 'Prediggo', 5 => 'Prediggo'),
            'multilang'			=> true,
            'multishopgroup'	=> false,
