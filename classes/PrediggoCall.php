...
class PrediggoCall
{
    ...
    /**
     * Get the supplier data from the prestashop Db by the retrieved recommendations Ids
     *
     * @param int $sSupplier supplier ID
     * @return array of supplier data from Db
     */
    public function getSuppliers($sSupplier)
    {
        $sql = 'SELECT `name`
